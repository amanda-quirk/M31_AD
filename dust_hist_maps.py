...
plt.plot(MS_bins, MS_y, c='b', label=r'$\rm MS$', linestyle='--')
plt.plot(AGy_bins, AGy_y, c='m', label=r'$\rm young\ AGB$', linestyle=':')
plt.plot(AGo_bins, AGo_y, c='green', label=r'$\rm old\ AGB$', linestyle='-.')
plt.plot(RG_bins, RG_y, c='r', label=r'$\rm RGB$')
