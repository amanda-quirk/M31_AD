...
plt.hist(AGy_ad_CO,  bins=range(-200, 300, 20),label='young AGB={} stars'.format(len(AGy_ad_CO)),normed=1, histtype='step', linewidth=1.6,stacked=True,fill=False, color='m', hatch='//', alpha=0.4)
plt.hist(AGo_ad_CO,  bins=range(-200, 300, 20),label='older AGB={} stars'.format(len(AGo_ad_CO)),normed=1,histtype='step', linewidth=1.6,stacked=True,fill=True, color='green', alpha=0.4)
