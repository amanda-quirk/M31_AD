...
elb1 = plt.errorbar(log_age, CO_AD, yerr=CO_errors, capsize=3, c='darkcyan', label=r'$\rm w.r.t.\ CO$')
elb2 = plt.errorbar(log_age, HI_AD, yerr=HI_errors, capsize=5,  c='darkgrey', linestyle='-', label=r'$\rm w.r.t.\ HI$')
...
plt.savefig('/Users/amandaquirk/Desktop/AD_transition_both.pdf', bbox_inches='tight')
#print('HI IWM')
#print(HI_errors)
#print('CO')
#print(CO_errors)
