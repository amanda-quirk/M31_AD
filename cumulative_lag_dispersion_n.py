...
axes[0].plot(dis_MS_bins, MS_dispersion_y_1, c='mediumpurple', label=r'$N_{\rmHI}=1$')
axes[0].plot(dis_MS_bins, MS_dispersion_y_2, c='deepskyblue', label=r'$N_{\rmHI}=2$')
axes[0].plot(dis_MS_bins, MS_dispersion_y_3, c='lightgreen',label=r'$N_{\rmHI}=3$')
axes[0].plot(dis_MS_bins, MS_dispersion_y_4, c='orange', label=r'$N_{\rmHI}=4$')
axes[0].plot(dis_MS_bins, MS_dispersion_y_5, c='r', label=r'$N_{\rmHI}=5$')

#axes[1].plot([0,0], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[1].plot([75,75], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[1].plot(dis_AGy_bins, AGy_dispersion_y_1, c='mediumpurple', label='n=1')
axes[1].plot(dis_AGy_bins, AGy_dispersion_y_2, c='deepskyblue', label='n=2')
axes[1].plot(dis_AGy_bins, AGy_dispersion_y_3, c='lightgreen',label='n=3')
axes[1].plot(dis_AGy_bins, AGy_dispersion_y_4, c='orange', label='n=4')
axes[1].plot(dis_AGy_bins, AGy_dispersion_y_5, c='r', label='n=5')

#axes[2].plot([0,0], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[2].plot([75,75], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[2].plot(dis_AGo_bins, AGo_dispersion_y_1, c='mediumpurple', label='n=1')
axes[2].plot(dis_AGo_bins, AGo_dispersion_y_2, c='deepskyblue', label='n=2')
axes[2].plot(dis_AGo_bins, AGo_dispersion_y_3, c='lightgreen',label='n=3')
axes[2].plot(dis_AGo_bins, AGo_dispersion_y_4, c='orange', label='n=4')
axes[2].plot(dis_AGo_bins, AGo_dispersion_y_5, c='r', label='n=5')

#axes[3].plot([0,0], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[3].plot([75,75], [-0.2,1.2], c='darkgrey', linestyle='--')
axes[3].plot(dis_RG_bins, RG_dispersion_y_1, c='mediumpurple', label='n=1')
axes[3].plot(dis_RG_bins, RG_dispersion_y_2, c='deepskyblue', label='n=2')
axes[3].plot(dis_RG_bins, RG_dispersion_y_3, c='lightgreen',label='n=3')
axes[3].plot(dis_RG_bins, RG_dispersion_y_4, c='orange', label='n=4')
axes[3].plot(dis_RG_bins, RG_dispersion_y_5, c='r', label='n=5')
...
f.text(0.5, 0.008, r'$\rmVelocity\ Dispersion:\ \sigma\ \rm(km\ s^{-1})$', ha='center', fontsize=13)
plt.savefig('/Users/amandaquirk/Desktop/dis_hist.pdf', bbox_inches='tight')
plt.close()
